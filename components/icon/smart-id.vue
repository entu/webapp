<template>
  <svg
    viewBox="0 0 89.2 88.7"
    xmlns="http://www.w3.org/2000/svg"
  >
    <path
      fill="currentColor"
      d="M56.1,27.8c0,1.8-1.4,3.2-3.2,3.2c-1.8,0-3.2-1.4-3.2-3.2s1.4-3.2,3.2-3.2C54.7,24.6,56.1,26,56.1,27.8"
    />
    <path
      fill="currentColor"
      d="M69.5,80.6c-0.8,0-1.6-0.4-2.1-1c-0.8-1.1-0.6-2.7,0.5-3.6c10.1-7.4,16.1-19.2,16.1-31.7
...
"
    ...
    <path
      fill="currentColor"
      d="M44.6,88.8C20,88.8,0,68.8,0,44.4C0,30.3,6.8,16.9,18.2,8.6C19.4,7.7,21,8,21.8,9.1c0.8,1.1,0.6,2.7-0.5,3.6
