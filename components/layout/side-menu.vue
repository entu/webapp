...
const authMenu = computed(() => [
  ...
  {
    key: 'auth-google',
    icon: () => h(IconGoogle, { class: 'size-5' }),
    label: () => h(NuxtLink,
      { to: { path: '/auth/google' } },
      { default: () => 'Google' }
    )
  ...
  {
    key: 'auth-sid',
    icon: () => h(IconSmartId, { class: 'size-5' }),
    label: () => h(NuxtLink,
  ...
  {
    key: 'auth-mid',
    icon: () => h(IconMobileId, { class: 'size-5' }),
    label: () => h(NuxtLink,
  ...
  {
    key: 'auth-idc',
    icon: () => h(IconIdCard, { class: 'size-5' }),
    label: () => h(NuxtLink,
...
const userMenu = computed(() => {
  ...
  if (accountId.value && userId.value) {
    ...
    menu.push({
      key: 'auth',
      icon: () => h(IconLogout, { class: 'size-5' }),
      label: () => h(NuxtLink,
        { to: { path: '/auth/exit' } },
        { default: () => t('signOut') }
      )
  ...
  menu.push({
    ...
    icon: () => h(IconLanguage, { class: 'size-5' }),
    label: () => h('a',
      { onClick: () => setLanguage() },
      { default: () => t('language') }
    )
